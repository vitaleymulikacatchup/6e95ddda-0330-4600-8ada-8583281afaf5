...
export const metadata: Metadata = {
  title: "Michal Zeidman - Cloud Security & Business Growth Expert",
  description: "Account Executive at Orca Security specializing in cloud security solutions and business growth. Experienced professional driving enterprise success.",
  keywords: ["cloud security", "business growth", "account executive", "Orca Security", "cybersecurity", "enterprise solutions"],
  metadataBase: new URL("https://michal-zeidman.com"),
  alternates: {
    canonical: "https://michal-zeidman.com"
  },
  openGraph: {
    title: "Michal Zeidman - Cloud Security & Business Growth Expert",
    description: "Account Executive at Orca Security specializing in cloud security solutions and business growth. Experienced professional driving enterprise success.",
    siteName: "Michal Zeidman",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/7006136/pexels-photo-7006136.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Michal Zeidman professional portrait"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Michal Zeidman - Cloud Security & Business Growth Expert",
    description: "Account Executive at Orca Security specializing in cloud security solutions and business growth.",
    images: ["https://images.pexels.com/photos/7006136/pexels-photo-7006136.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
